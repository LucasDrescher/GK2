...
export const globalStyles = StyleSheet.create({
  ...
  // Clean Dashboard styles - Minimalistisk og professionelt design
  dashboardContainer: {
    flex: 1,
  ...
  // Stats grid - Clean minimalistisk design
  statsGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 16,
  ...
  // Stat cards - Simpel og professionel
  statCard: {
    backgroundColor: '#ffffff',
    borderRadius: 8,
    padding: 20,
